    ...
    public class Buttons
    {
        public static ButtonInfo[][] buttons = new ButtonInfo[][]
        {
            ...
            new ButtonInfo[] { // Menu Settings [2]
                ...
                new ButtonInfo { buttonText = "Inner Outline Menu", enableMethod =() => Settings.InnerOutlineMenuOn(), disableMethod =() => Settings.InnerOutlineMenuOff(), toolTip = "Gives the menu an outline on the inside."},
                ...
                new ButtonInfo { buttonText = "Gun Sounds", enableMethod =() => Settings.EnableGunSounds(), disableMethod =() => Settings.DisableGunSounds(), toolTip = "Gives the gun laser sounds for when you press grip and trigger."},
...
new ButtonInfo { buttonText = "Auto Join Room \"ALECVR\"", method =() => rejRoom = "ALECVR", isTogglable = false, toolTip = "Automatically attempts to connect to room \"ALECVR\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"DEEP\"", method =() => rejRoom = "DEEP", isTogglable = false, toolTip = "Automatically attempts to connect to room \"DEEP\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"JUAN\"", method =() => rejRoom = "JUAN", isTogglable = false, toolTip = "Automatically attempts to connect to room \"JUAN\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"MELT\"", method =() => rejRoom = "MELT", isTogglable = false, toolTip = "Automatically attempts to connect to room \"MELT\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"ELLIOT1\"", method =() => rejRoom = "ELLIOT1", isTogglable = false, toolTip = "Automatically attempts to connect to room \"ELLIOT1\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"ELLIOT2\"", method =() => rejRoom = "ELLIOT2", isTogglable = false, toolTip = "Automatically attempts to connect to room \"ELLIOT2\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"VMT\"", method =() => rejRoom = "VMT", isTogglable = false, toolTip = "Automatically attempts to connect to room \"VMT\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"K9\"", method =() => rejRoom = "K9", isTogglable = false, toolTip = "Automatically attempts to connect to room \"K9\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"HUNT\"", method =() => rejRoom = "HUNT", isTogglable = false, toolTip = "Automatically attempts to connect to room \"HUNT\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"MEET2\"", method =() => rejRoom = "MEET2", isTogglable = false, toolTip = "Automatically attempts to connect to room \"MEET2\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"MEET3\"", method =() => rejRoom = "MEET3", isTogglable = false, toolTip = "Automatically attempts to connect to room \"MEET3\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"GTAG\"", method =() => rejRoom = "GTAG", isTogglable = false, toolTip = "Automatically attempts to connect to room \"GTAG\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"MEET4\"", method =() => rejRoom = "MEET4", isTogglable = false, toolTip = "Automatically attempts to connect to room \"MEET4\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"MEET5\"", method =() => rejRoom = "MEET5", isTogglable = false, toolTip = "Automatically attempts to connect to room \"MEET5\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"MEET6\"", method =() => rejRoom = "MEET6", isTogglable = false, toolTip = "Automatically attempts to connect to room \"MEET6\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"MEET7\"", method =() => rejRoom = "MEET7", isTogglable = false, toolTip = "Automatically attempts to connect to room \"MEET7\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"MEET8\"", method =() => rejRoom = "MEET8", isTogglable = false, toolTip = "Automatically attempts to connect to room \"MEET8\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"QWERTY\"", method =() => rejRoom = "QWERTY", isTogglable = false, toolTip = "Automatically attempts to connect to room \"QWERTY\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"QWERTYUIOP\"", method =() => rejRoom = "QWERTYUIOP", isTogglable = false, toolTip = "Automatically attempts to connect to room \"QWERTYUIOP\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"SILLY\"", method =() => rejRoom = "SILLY", isTogglable = false, toolTip = "Automatically attempts to connect to room \"SILLY\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"TILLY\"", method =() => rejRoom = "TILLY", isTogglable = false, toolTip = "Automatically attempts to connect to room \"TILLY\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"VEN2\"", method =() => rejRoom = "VEN2", isTogglable = false, toolTip = "Automatically attempts to connect to room \"VEN2\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"RANG\"", method =() => rejRoom = "RANG", isTogglable = false, toolTip = "Automatically attempts to connect to room \"RANG\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"GTC\"", method =() => rejRoom = "GTC", isTogglable = false, toolTip = "Automatically attempts to connect to room \"GTC\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"DYL\"", method =() => rejRoom = "DYL", isTogglable = false, toolTip = "Automatically attempts to connect to room \"DYL\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"TAG\"", method =() => rejRoom = "TAG", isTogglable = false, toolTip = "Automatically attempts to connect to room \"TAG\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"TTT\"", method =() => rejRoom = "TTT", isTogglable = false, toolTip = "Automatically attempts to connect to room \"TTT\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"TTTPIG\"", method =() => rejRoom = "TTTPIG", isTogglable = false, toolTip = "Automatically attempts to connect to room \"TTTPIG\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"PIG\"", method =() => rejRoom = "PIG", isTogglable = false, toolTip = "Automatically attempts to connect to room \"PIG\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"MINIGAM\"", method =() => rejRoom = "MINIGAM", isTogglable = false, toolTip = "Automatically attempts to connect to room \"MINIGAM\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"MINIGAME\"", method =() => rejRoom = "MINIGAME", isTogglable = false, toolTip = "Automatically attempts to connect to room \"MINIGAME\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"MINIGAMES\"", method =() => rejRoom = "MINIGAMES", isTogglable = false, toolTip = "Automatically attempts to connect to room \"MINIGAMES\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"MALLRUSH\"", method =() => rejRoom = "MALLRUSH", isTogglable = false, toolTip = "Automatically attempts to connect to room \"MALLRUSH\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"COLORRUSH\"", method =() => rejRoom = "COLORRUSH", isTogglable = false, toolTip = "Automatically attempts to connect to room \"COLORRUSH\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"SHELF\"", method =() => rejRoom = "SHELF", isTogglable = false, toolTip = "Automatically attempts to connect to room \"SHELF\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"ROLEPLAY\"", method =() => rejRoom = "ROLEPLAY", isTogglable = false, toolTip = "Automatically attempts to connect to room \"ROLEPLAY\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"GORILLA\"", method =() => rejRoom = "GORILLA", isTogglable = false, toolTip = "Automatically attempts to connect to room \"GORILLA\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"MONKE\"", method =() => rejRoom = "MONKE", isTogglable = false, toolTip = "Automatically attempts to connect to room \"MONKE\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"MONKEY\"", method =() => rejRoom = "MONKEY", isTogglable = false, toolTip = "Automatically attempts to connect to room \"MONKEY\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"MIRRORMAN\"", method =() => rejRoom = "MIRRORMAN", isTogglable = false, toolTip = "Automatically attempts to connect to room \"MIRRORMAN\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"ERROR\"", method =() => rejRoom = "ERROR", isTogglable = false, toolTip = "Automatically attempts to connect to room \"ERROR\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"RUN555999\"", method =() => rejRoom = "RUN555999", isTogglable = false, toolTip = "Automatically attempts to connect to room \"RUN555999\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"SREN18\"", method =() => rejRoom = "SREN18", isTogglable = false, toolTip = "Automatically attempts to connect to room \"SREN18\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"SREN16\"", method =() => rejRoom = "SREN16", isTogglable = false, toolTip = "Automatically attempts to connect to room \"SREN16\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"COMP\"", method =() => rejRoom = "COMP", isTogglable = false, toolTip = "Automatically attempts to connect to room \"COMP\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"J3VU\"", method =() => rejRoom = "J3VU", isTogglable = false, toolTip = "Automatically attempts to connect to room \"J3VU\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"ECHO\"", method =() => rejRoom = "ECHO", isTogglable = false, toolTip = "Automatically attempts to connect to room \"ECHO\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"555999\"", method =() => rejRoom = "555999", isTogglable = false, toolTip = "Automatically attempts to connect to room \"555999\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"STATUE\"", method =() => rejRoom = "STATUE", isTogglable = false, toolTip = "Automatically attempts to connect to room \"STATUE\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"DAISYDAISY\"", method =() => rejRoom = "DAISYDAISY", isTogglable = false, toolTip = "Automatically attempts to connect to room \"DAISYDAISY\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"DAISY08\"", method =() => rejRoom = "DAISY08", isTogglable = false, toolTip = "Automatically attempts to connect to room \"DAISY08\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"CHIPPD\"", method =() => rejRoom = "CHIPPD", isTogglable = false, toolTip = "Automatically attempts to connect to room \"CHIPPD\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"BANSHEE\"", method =() => rejRoom = "BANSHEE", isTogglable = false, toolTip = "Automatically attempts to connect to room \"BANSHEE\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"123\"", method =() => rejRoom = "123", isTogglable = false, toolTip = "Automatically attempts to connect to room \"123\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"1234\"", method =() => rejRoom = "1234", isTogglable = false, toolTip = "Automatically attempts to connect to room \"1234\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"12345\"", method =() => rejRoom = "12345", isTogglable = false, toolTip = "Automatically attempts to connect to room \"12345\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"123456\"", method =() => rejRoom = "123456", isTogglable = false, toolTip = "Automatically attempts to connect to room \"123456\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"1234567\"", method =() => rejRoom = "1234567", isTogglable = false, toolTip = "Automatically attempts to connect to room \"1234567\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"12345678\"", method =() => rejRoom = "12345678", isTogglable = false, toolTip = "Automatically attempts to connect to room \"12345678\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"123456789\"", method =() => rejRoom = "123456789", isTogglable = false, toolTip = "Automatically attempts to connect to room \"123456789\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"1234567890\"", method =() => rejRoom = "1234567890", isTogglable = false, toolTip = "Automatically attempts to connect to room \"1234567890\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"ALEC\"", method =() => rejRoom = "ALEC", isTogglable = false, toolTip = "Automatically attempts to connect to room \"ALEC\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"MAXO\"", method =() => rejRoom = "MAXO", isTogglable = false, toolTip = "Automatically attempts to connect to room \"MAXO\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"1\"", method =() => rejRoom = "1", isTogglable = false, toolTip = "Automatically attempts to connect to room \"1\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"2\"", method =() => rejRoom = "2", isTogglable = false, toolTip = "Automatically attempts to connect to room \"2\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"3\"", method =() => rejRoom = "3", isTogglable = false, toolTip = "Automatically attempts to connect to room \"3\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"4\"", method =() => rejRoom = "4", isTogglable = false, toolTip = "Automatically attempts to connect to room \"4\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"5\"", method =() => rejRoom = "5", isTogglable = false, toolTip = "Automatically attempts to connect to room \"5\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"6\"", method =() => rejRoom = "6", isTogglable = false, toolTip = "Automatically attempts to connect to room \"6\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"7\"", method =() => rejRoom = "7", isTogglable = false, toolTip = "Automatically attempts to connect to room \"7\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"8\"", method =() => rejRoom = "8", isTogglable = false, toolTip = "Automatically attempts to connect to room \"8\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"9\"", method =() => rejRoom = "9", isTogglable = false, toolTip = "Automatically attempts to connect to room \"9\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"0\"", method =() => rejRoom = "0", isTogglable = false, toolTip = "Automatically attempts to connect to room \"0\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"ECT\"", method =() => rejRoom = "ECT", isTogglable = false, toolTip = "Automatically attempts to connect to room \"ECT\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"MINI\"", method =() => rejRoom = "MINI", isTogglable = false, toolTip = "Automatically attempts to connect to room \"MINI\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"VEN\"", method =() => rejRoom = "VEN", isTogglable = false, toolTip = "Automatically attempts to connect to room \"VEN\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"FOOT\"", method =() => rejRoom = "FOOT", isTogglable = false, toolTip = "Automatically attempts to connect to room \"FOOT\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"MONKER\"", method =() => rejRoom = "MONKER", isTogglable = false, toolTip = "Automatically attempts to connect to room \"MONKER\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"FAADDUU\"", method =() => rejRoom = "FAADDUU", isTogglable = false, toolTip = "Automatically attempts to connect to room \"FAADDUU\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"FAADDUUVR\"", method =() => rejRoom = "FAADDUUVR", isTogglable = false, toolTip = "Automatically attempts to connect to room \"FAADDUUVR\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"CUBCUB\"", method =() => rejRoom = "CUBCUB", isTogglable = false, toolTip = "Automatically attempts to connect to room \"CUBCUB\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"CUBCUB11\"", method =() => rejRoom = "CUBCUB11", isTogglable = false, toolTip = "Automatically attempts to connect to room \"CUBCUB11\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"BUBBLESVR\"", method =() => rejRoom = "BUBBLESVR", isTogglable = false, toolTip = "Automatically attempts to connect to room \"BUBBLESVR\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"ELLIOTVR\"", method =() => rejRoom = "ELLIOTVR", isTogglable = false, toolTip = "Automatically attempts to connect to room \"ELLIOTVR\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"ELLIOT3\"", method =() => rejRoom = "ELLIOT3", isTogglable = false, toolTip = "Automatically attempts to connect to room \"ELLIOT3\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"STYLED\"", method =() => rejRoom = "STYLED", isTogglable = false, toolTip = "Automatically attempts to connect to room \"STYLED\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"SNAIL\"", method =() => rejRoom = "SNAIL", isTogglable = false, toolTip = "Automatically attempts to connect to room \"SNAIL\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"STYLEDSNAIL\"", method =() => rejRoom = "STYLEDSNAIL", isTogglable = false, toolTip = "Automatically attempts to connect to room \"STYLEDSNAIL\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"JUITAR\"", method =() => rejRoom = "JUITAR", isTogglable = false, toolTip = "Automatically attempts to connect to room \"JUITAR\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"FIIZY\"", method =() => rejRoom = "FIIZY", isTogglable = false, toolTip = "Automatically attempts to connect to room \"FIIZY\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"ITSFIIZY\"", method =() => rejRoom = "ITSFIIZY", isTogglable = false, toolTip = "Automatically attempts to connect to room \"ITSFIIZY\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"CHRISNADO\"", method =() => rejRoom = "CHRISNADO", isTogglable = false, toolTip = "Automatically attempts to connect to room \"CHRISNADO\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"MAJORA\"", method =() => rejRoom = "MAJORA", isTogglable = false, toolTip = "Automatically attempts to connect to room \"MAJORA\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"ANTOCA\"", method =() => rejRoom = "ANTOCA", isTogglable = false, toolTip = "Automatically attempts to connect to room \"ANTOCA\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"STICK\"", method =() => rejRoom = "STICK", isTogglable = false, toolTip = "Automatically attempts to connect to room \"STICK\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"STICKS\"", method =() => rejRoom = "STICKS", isTogglable = false, toolTip = "Automatically attempts to connect to room \"STICKS\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"GTAG\"", method =() => rejRoom = "GTAG", isTogglable = false, toolTip = "Automatically attempts to connect to room \"GTAG\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"SKIBIDI\"", method =() => rejRoom = "SKIBIDI", isTogglable = false, toolTip = "Automatically attempts to connect to room \"SKIBIDI\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"IDEN\"", method =() => rejRoom = "IDEN", isTogglable = false, toolTip = "Automatically attempts to connect to room \"IDEN\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"IDENVR\"", method =() => rejRoom = "IDENVR", isTogglable = false, toolTip = "Automatically attempts to connect to room \"IDENVR\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"GAY\"", method =() => rejRoom = "GAY", isTogglable = false, toolTip = "Automatically attempts to connect to room \"GAY\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"ABC\"", method =() => rejRoom = "ABC", isTogglable = false, toolTip = "Automatically attempts to connect to room \"ABC\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"ABCD\"", method =() => rejRoom = "ABCD", isTogglable = false, toolTip = "Automatically attempts to connect to room \"ABCD\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"A\"", method =() => rejRoom = "A", isTogglable = false, toolTip = "Automatically attempts to connect to room \"A\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"B\"", method =() => rejRoom = "B", isTogglable = false, toolTip = "Automatically attempts to connect to room \"B\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"C\"", method =() => rejRoom = "C", isTogglable = false, toolTip = "Automatically attempts to connect to room \"C\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"D\"", method =() => rejRoom = "D", isTogglable = false, toolTip = "Automatically attempts to connect to room \"D\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"E\"", method =() => rejRoom = "E", isTogglable = false, toolTip = "Automatically attempts to connect to room \"E\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"F\"", method =() => rejRoom = "F", isTogglable = false, toolTip = "Automatically attempts to connect to room \"F\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"G\"", method =() => rejRoom = "G", isTogglable = false, toolTip = "Automatically attempts to connect to room \"G\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"H\"", method =() => rejRoom = "H", isTogglable = false, toolTip = "Automatically attempts to connect to room \"H\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"I\"", method =() => rejRoom = "I", isTogglable = false, toolTip = "Automatically attempts to connect to room \"I\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"J\"", method =() => rejRoom = "J", isTogglable = false, toolTip = "Automatically attempts to connect to room \"J\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"K\"", method =() => rejRoom = "K", isTogglable = false, toolTip = "Automatically attempts to connect to room \"K\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"L\"", method =() => rejRoom = "L", isTogglable = false, toolTip = "Automatically attempts to connect to room \"L\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"M\"", method =() => rejRoom = "M", isTogglable = false, toolTip = "Automatically attempts to connect to room \"M\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"N\"", method =() => rejRoom = "N", isTogglable = false, toolTip = "Automatically attempts to connect to room \"N\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"O\"", method =() => rejRoom = "O", isTogglable = false, toolTip = "Automatically attempts to connect to room \"O\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"P\"", method =() => rejRoom = "P", isTogglable = false, toolTip = "Automatically attempts to connect to room \"P\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"Q\"", method =() => rejRoom = "Q", isTogglable = false, toolTip = "Automatically attempts to connect to room \"Q\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"R\"", method =() => rejRoom = "R", isTogglable = false, toolTip = "Automatically attempts to connect to room \"R\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"S\"", method =() => rejRoom = "S", isTogglable = false, toolTip = "Automatically attempts to connect to room \"S\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"T\"", method =() => rejRoom = "T", isTogglable = false, toolTip = "Automatically attempts to connect to room \"T\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"U\"", method =() => rejRoom = "U", isTogglable = false, toolTip = "Automatically attempts to connect to room \"U\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"V\"", method =() => rejRoom = "V", isTogglable = false, toolTip = "Automatically attempts to connect to room \"V\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"W\"", method =() => rejRoom = "W", isTogglable = false, toolTip = "Automatically attempts to connect to room \"W\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"X\"", method =() => rejRoom = "X", isTogglable = false, toolTip = "Automatically attempts to connect to room \"X\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"Y\"", method =() => rejRoom = "Y", isTogglable = false, toolTip = "Automatically attempts to connect to room \"Y\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"Z\"", method =() => rejRoom = "Z", isTogglable = false, toolTip = "Automatically attempts to connect to room \"Z\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"AMXR\"", method =() => rejRoom = "AMXR", isTogglable = false, toolTip = "Automatically attempts to connect to room \"AMXR\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"ZERDY\"", method =() => rejRoom = "ZERDY", isTogglable = false, toolTip = "Automatically attempts to connect to room \"ZERDY\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"DAPPER\"", method =() => rejRoom = "DAPPER", isTogglable = false, toolTip = "Automatically attempts to connect to room \"DAPPER\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"TURBO\"", method =() => rejRoom = "TURBO", isTogglable = false, toolTip = "Automatically attempts to connect to room \"TURBO\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"MOSA\"", method =() => rejRoom = "MOSA", isTogglable = false, toolTip = "Automatically attempts to connect to room \"MOSA\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"RAKZZ\"", method =() => rejRoom = "RAKZZ", isTogglable = false, toolTip = "Automatically attempts to connect to room \"RAKZZ\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"AUSSIE\"", method =() => rejRoom = "AUSSIE", isTogglable = false, toolTip = "Automatically attempts to connect to room \"AUSSIE\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"H4KPY\"", method =() => rejRoom = "H4KPY", isTogglable = false, toolTip = "Automatically attempts to connect to room \"H4KPY\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"DAPPERSLUG\"", method =() => rejRoom = "DAPPERSLUG", isTogglable = false, toolTip = "Automatically attempts to connect to room \"DAPPERSLUG\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"CODY\"", method =() => rejRoom = "CODY", isTogglable = false, toolTip = "Automatically attempts to connect to room \"CODY\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"QUINN\"", method =() => rejRoom = "QUINN", isTogglable = false, toolTip = "Automatically attempts to connect to room \"QUINN\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"LEOVR\"", method =() => rejRoom = "LEOVR", isTogglable = false, toolTip = "Automatically attempts to connect to room \"LEOVR\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"LEO\"", method =() => rejRoom = "LEO", isTogglable = false, toolTip = "Automatically attempts to connect to room \"LEO\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"PARTYMONKEY\"", method =() => rejRoom = "PARTYMONKEY", isTogglable = false, toolTip = "Automatically attempts to connect to room \"PARTYMONKEY\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"BOETHIA\"", method =() => rejRoom = "BOETHIA", isTogglable = false, toolTip = "Automatically attempts to connect to room \"BOETHIA\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"CHIVI\"", method =() => rejRoom = "CHIVI", isTogglable = false, toolTip = "Automatically attempts to connect to room \"CHIVI\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"HEADCHEF\"", method =() => rejRoom = "HEADCHEF", isTogglable = false, toolTip = "Automatically attempts to connect to room \"HEADCHEF\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"HEADCHEFVR\"", method =() => rejRoom = "HEADCHEFVR", isTogglable = false, toolTip = "Automatically attempts to connect to room \"HEADCHEFVR\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"KNINLY\"", method =() => rejRoom = "KNINLY", isTogglable = false, toolTip = "Automatically attempts to connect to room \"KNINLY\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"JAWCLAMPS\"", method =() => rejRoom = "JAWCLAMPS", isTogglable = false, toolTip = "Automatically attempts to connect to room \"JAWCLAMPS\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"KISHARK\"", method =() => rejRoom = "KISHARK", isTogglable = false, toolTip = "Automatically attempts to connect to room \"KISHARK\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"WIDDOM\"", method =() => rejRoom = "WIDDOM", isTogglable = false, toolTip = "Automatically attempts to connect to room \"WIDDOM\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"TIKTOK\"", method =() => rejRoom = "TIKTOK", isTogglable = false, toolTip = "Automatically attempts to connect to room \"TIKTOK\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"YOUTUBER\"", method =() => rejRoom = "YOUTUBER", isTogglable = false, toolTip = "Automatically attempts to connect to room \"YOUTUBER\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"GTC1\"", method =() => rejRoom = "GTC1", isTogglable = false, toolTip = "Automatically attempts to connect to room \"GTC1\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"GTC2\"", method =() => rejRoom = "GTC2", isTogglable = false, toolTip = "Automatically attempts to connect to room \"GTC2\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"GTC3\"", method =() => rejRoom = "GTC3", isTogglable = false, toolTip = "Automatically attempts to connect to room \"GTC3\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"GTC4\"", method =() => rejRoom = "GTC4", isTogglable = false, toolTip = "Automatically attempts to connect to room \"GTC4\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"GTC5\"", method =() => rejRoom = "GTC5", isTogglable = false, toolTip = "Automatically attempts to connect to room \"GTC5\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"GTC6\"", method =() => rejRoom = "GTC6", isTogglable = false, toolTip = "Automatically attempts to connect to room \"GTC6\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"GTC7\"", method =() => rejRoom = "GTC7", isTogglable = false, toolTip = "Automatically attempts to connect to room \"GTC7\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"GTC8\"", method =() => rejRoom = "GTC8", isTogglable = false, toolTip = "Automatically attempts to connect to room \"GTC8\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"GTC9\"", method =() => rejRoom = "GTC9", isTogglable = false, toolTip = "Automatically attempts to connect to room \"GTC9\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"GTC10\"", method =() => rejRoom = "GTC10", isTogglable = false, toolTip = "Automatically attempts to connect to room \"GTC10\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"AA\"", method =() => rejRoom = "AA", isTogglable = false, toolTip = "Automatically attempts to connect to room \"AA\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"THUMBZ\"", method =() => rejRoom = "THUMBZ", isTogglable = false, toolTip = "Automatically attempts to connect to room \"THUMBZ\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"JMAN1\"", method =() => rejRoom = "JMAN1", isTogglable = false, toolTip = "Automatically attempts to connect to room \"JMAN1\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"K8\"", method =() => rejRoom = "K8", isTogglable = false, toolTip = "Automatically attempts to connect to room \"K8\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"TIMMY\"", method =() => rejRoom = "TIMMY", isTogglable = false, toolTip = "Automatically attempts to connect to room \"TIMMY\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"JMAN2\"", method =() => rejRoom = "JMAN2", isTogglable = false, toolTip = "Automatically attempts to connect to room \"JMAN2\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"JMAN3\"", method =() => rejRoom = "JMAN3", isTogglable = false, toolTip = "Automatically attempts to connect to room \"JMAN3\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"GT\"", method =() => rejRoom = "GT", isTogglable = false, toolTip = "Automatically attempts to connect to room \"GT\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"CGT\"", method =() => rejRoom = "CGT", isTogglable = false, toolTip = "Automatically attempts to connect to room \"CGT\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"RUN1\"", method =() => rejRoom = "RUN1", isTogglable = false, toolTip = "Automatically attempts to connect to room \"RUN1\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"666\"", method =() => rejRoom = "666", isTogglable = false, toolTip = "Automatically attempts to connect to room \"666\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"LEAH\"", method =() => rejRoom = "LEAH", isTogglable = false, toolTip = "Automatically attempts to connect to room \"LEAH\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"DAISY099\"", method =() => rejRoom = "DAISY099", isTogglable = false, toolTip = "Automatically attempts to connect to room \"DAISY099\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"ENDISHERE\"", method =() => rejRoom = "ENDISHERE", isTogglable = false, toolTip = "Automatically attempts to connect to room \"ENDISHERE\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"BANJO\"", method =() => rejRoom = "BANJO", isTogglable = false, toolTip = "Automatically attempts to connect to room \"BANJO\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"CHIPPDBANJO\"", method =() => rejRoom = "CHIPPDBANJO", isTogglable = false, toolTip = "Automatically attempts to connect to room \"CHIPPDBANJO\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"GH0ST\"", method =() => rejRoom = "GH0ST", isTogglable = false, toolTip = "Automatically attempts to connect to room \"GH0ST\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"END\"", method =() => rejRoom = "END", isTogglable = false, toolTip = "Automatically attempts to connect to room \"END\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"DEATH\"", method =() => rejRoom = "DEATH", isTogglable = false, toolTip = "Automatically attempts to connect to room \"DEATH\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"FNAF\"", method =() => rejRoom = "FNAF", isTogglable = false, toolTip = "Automatically attempts to connect to room \"FNAF\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"ECH0\"", method =() => rejRoom = "ECH0", isTogglable = false, toolTip = "Automatically attempts to connect to room \"ECH0\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"BANANA\"", method =() => rejRoom = "BANANA", isTogglable = false, toolTip = "Automatically attempts to connect to room \"BANANA\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"SMILER\"", method =() => rejRoom = "SMILER", isTogglable = false, toolTip = "Automatically attempts to connect to room \"SMILER\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"UNKNOWN\"", method =() => rejRoom = "UNKNOWN", isTogglable = false, toolTip = "Automatically attempts to connect to room \"UNKNOWN\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"BOTS\"", method =() => rejRoom = "BOTS", isTogglable = false, toolTip = "Automatically attempts to connect to room \"BOTS\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"DEAD\"", method =() => rejRoom = "DEAD", isTogglable = false, toolTip = "Automatically attempts to connect to room \"DEAD\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"MORSE\"", method =() => rejRoom = "MORSE", isTogglable = false, toolTip = "Automatically attempts to connect to room \"MORSE\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"SPIDER\"", method =() => rejRoom = "SPIDER", isTogglable = false, toolTip = "Automatically attempts to connect to room \"SPIDER\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"MONK\"", method =() => rejRoom = "MONK", isTogglable = false, toolTip = "Automatically attempts to connect to room \"MONK\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"MODDER\"", method =() => rejRoom = "MODDER", isTogglable = false, toolTip = "Automatically attempts to connect to room \"MODDER\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"MODDERS\"", method =() => rejRoom = "MODDERS", isTogglable = false, toolTip = "Automatically attempts to connect to room \"MODDERS\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"MODERATOR\"", method =() => rejRoom = "MODERATOR", isTogglable = false, toolTip = "Automatically attempts to connect to room \"MODERATOR\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"BODA\"", method =() => rejRoom = "BODA", isTogglable = false, toolTip = "Automatically attempts to connect to room \"BODA\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"JOLYENE\"", method =() => rejRoom = "JOLYENE", isTogglable = false, toolTip = "Automatically attempts to connect to room \"JOLYENE\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"ELECTRONIC\"", method =() => rejRoom = "ELECTRONIC", isTogglable = false, toolTip = "Automatically attempts to connect to room \"ELECTRONIC\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"OWNER\"", method =() => rejRoom = "OWNER", isTogglable = false, toolTip = "Automatically attempts to connect to room \"OWNER\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"DEV\"", method =() => rejRoom = "DEV", isTogglable = false, toolTip = "Automatically attempts to connect to room \"DEV\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"CREATOR\"", method =() => rejRoom = "CREATOR", isTogglable = false, toolTip = "Automatically attempts to connect to room \"CREATOR\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"11\"", method =() => rejRoom = "11", isTogglable = false, toolTip = "Automatically attempts to connect to room \"11\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"12\"", method =() => rejRoom = "12", isTogglable = false, toolTip = "Automatically attempts to connect to room \"12\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"13\"", method =() => rejRoom = "13", isTogglable = false, toolTip = "Automatically attempts to connect to room \"13\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"14\"", method =() => rejRoom = "14", isTogglable = false, toolTip = "Automatically attempts to connect to room \"14\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"15\"", method =() => rejRoom = "15", isTogglable = false, toolTip = "Automatically attempts to connect to room \"15\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"16\"", method =() => rejRoom = "16", isTogglable = false, toolTip = "Automatically attempts to connect to room \"16\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"17\"", method =() => rejRoom = "17", isTogglable = false, toolTip = "Automatically attempts to connect to room \"17\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"18\"", method =() => rejRoom = "18", isTogglable = false, toolTip = "Automatically attempts to connect to room \"18\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"19\"", method =() => rejRoom = "19", isTogglable = false, toolTip = "Automatically attempts to connect to room \"19\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"20\"", method =() => rejRoom = "20", isTogglable = false, toolTip = "Automatically attempts to connect to room \"20\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"CREEP\"", method =() => rejRoom = "CREEP", isTogglable = false, toolTip = "Automatically attempts to connect to room \"CREEP\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"CREEPY\"", method =() => rejRoom = "CREEPY", isTogglable = false, toolTip = "Automatically attempts to connect to room \"CREEPY\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"SCARY\"", method =() => rejRoom = "SCARY", isTogglable = false, toolTip = "Automatically attempts to connect to room \"SCARY\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"SPOOKY\"", method =() => rejRoom = "SPOOKY", isTogglable = false, toolTip = "Automatically attempts to connect to room \"SPOOKY\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"SPOOK\"", method =() => rejRoom = "SPOOK", isTogglable = false, toolTip = "Automatically attempts to connect to room \"SPOOK\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"GAMES\"", method =() => rejRoom = "GAMES", isTogglable = false, toolTip = "Automatically attempts to connect to room \"GAMES\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"PLAY\"", method =() => rejRoom = "PLAY", isTogglable = false, toolTip = "Automatically attempts to connect to room \"PLAY\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"FINGERPAINTER\"", method =() => rejRoom = "FINGERPAINTER", isTogglable = false, toolTip = "Automatically attempts to connect to room \"FINGERPAINTER\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"CONTENTCREATOR\"", method =() => rejRoom = "CONTENTCREATOR", isTogglable = false, toolTip = "Automatically attempts to connect to room \"CONTENTCREATOR\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"CONTENT\"", method =() => rejRoom = "CONTENT", isTogglable = false, toolTip = "Automatically attempts to connect to room \"CONTENT\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"HELPME\"", method =() => rejRoom = "HELPME", isTogglable = false, toolTip = "Automatically attempts to connect to room \"HELPME\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"BEES\"", method =() => rejRoom = "BEES", isTogglable = false, toolTip = "Automatically attempts to connect to room \"BEES\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"NAMO\"", method =() => rejRoom = "NAMO", isTogglable = false, toolTip = "Automatically attempts to connect to room \"NAMO\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"WARNING\"", method =() => rejRoom = "WARNING", isTogglable = false, toolTip = "Automatically attempts to connect to room \"WARNING\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"HIDE\"", method =() => rejRoom = "HIDE", isTogglable = false, toolTip = "Automatically attempts to connect to room \"HIDE\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"WOW\"", method =() => rejRoom = "WOW", isTogglable = false, toolTip = "Automatically attempts to connect to room \"WOW\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"MITTENS\"", method =() => rejRoom = "MITTENS", isTogglable = false, toolTip = "Automatically attempts to connect to room \"MITTENS\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"RAY2\"", method =() => rejRoom = "RAY2", isTogglable = false, toolTip = "Automatically attempts to connect to room \"RAY2\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"RAY1\"", method =() => rejRoom = "RAY1", isTogglable = false, toolTip = "Automatically attempts to connect to room \"RAY1\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"GRAPES\"", method =() => rejRoom = "GRAPES", isTogglable = false, toolTip = "Automatically attempts to connect to room \"GRAPES\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"MICROPHONE\"", method =() => rejRoom = "MICROPHONE", isTogglable = false, toolTip = "Automatically attempts to connect to room \"MICROPHONE\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"BARK\"", method =() => rejRoom = "BARK", isTogglable = false, toolTip = "Automatically attempts to connect to room \"BARK\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"DURF\"", method =() => rejRoom = "DURF", isTogglable = false, toolTip = "Automatically attempts to connect to room \"DURF\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"JULIAN\"", method =() => rejRoom = "JULIAN", isTogglable = false, toolTip = "Automatically attempts to connect to room \"JULIAN\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"HAVEN\"", method =() => rejRoom = "HAVEN", isTogglable = false, toolTip = "Automatically attempts to connect to room \"HAVEN\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"VR\"", method =() => rejRoom = "VR", isTogglable = false, toolTip = "Automatically attempts to connect to room \"VR\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"WEAREVR\"", method =() => rejRoom = "WEAREVR", isTogglable = false, toolTip = "Automatically attempts to connect to room \"WEAREVR\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"FINGER\"", method =() => rejRoom = "FINGER", isTogglable = false, toolTip = "Automatically attempts to connect to room \"FINGER\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"PAINTER\"", method =() => rejRoom = "PAINTER", isTogglable = false, toolTip = "Automatically attempts to connect to room \"PAINTER\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"ADMIN\"", method =() => rejRoom = "ADMIN", isTogglable = false, toolTip = "Automatically attempts to connect to room \"ADMIN\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"STAFF\"", method =() => rejRoom = "STAFF", isTogglable = false, toolTip = "Automatically attempts to connect to room \"STAFF\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"CRASH\"", method =() => rejRoom = "CRASH", isTogglable = false, toolTip = "Automatically attempts to connect to room \"CRASH\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"YOUTUBE\"", method =() => rejRoom = "YOUTUBE", isTogglable = false, toolTip = "Automatically attempts to connect to room \"YOUTUBE\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"MODDING\"", method =() => rejRoom = "MODDING", isTogglable = false, toolTip = "Automatically attempts to connect to room \"MODDING\" every couple of seconds until connected." },
new ButtonInfo { buttonText = "Auto Join Room \"LEMMING\"", method =() => rejRoom = "LEMMING", isTogglable = false, toolTip = "Automatically attempts to connect to room \"LEMMING\" every couple of seconds until connected." },
            },
            ...
            new ButtonInfo[] { // Important Mods [7]
                ...
                new ButtonInfo { buttonText = "Disable Network Triggers", enableMethod =() => GameObject.Find("Environment Objects/TriggerZones_Prefab/JoinRoomTriggers_Prefab").SetActive(false), disableMethod =() => GameObject.Find("Environment Objects/TriggerZones_Prefab/JoinRoomTriggers_Prefab").SetActive(true), toolTip = "Disables the network triggers, so you can change maps without disconnecting."},
                ...
                new ButtonInfo { buttonText = "Disable Quit Box", enableMethod =() => GameObject.Find("Environment Objects/TriggerZones_Prefab/ZoneTransitions_Prefab/QuitBox").SetActive(false), disableMethod =() => GameObject.Find("Environment Objects/TriggerZones_Prefab/ZoneTransitions_Prefab/QuitBox").SetActive(true), toolTip = "Disables the box under the map that closes your game."},
                ...
                new ButtonInfo { buttonText = "60 FPS", method =() => Task.Delay(50), toolTip = "Caps your FPS at 60 frames per second."},
            ...
            new ButtonInfo[] { // Safety Mods [8]
                ...
                new ButtonInfo { buttonText = "Fake Broken Controller <color=grey>[</color><color=green>X</color><color=grey>]</color>", enableMethod =() => GameObject.Find("Player Objects/Player VR Controller/GorillaPlayer/TurnParent/LeftHandTriggerCollider").GetComponent<Collider>().enabled = false, method =() => Movement.FakeBrokenController(), disableMethod =() => GameObject.Find("Player Objects/Player VR Controller/GorillaPlayer/TurnParent/LeftHandTriggerCollider").GetComponent<Collider>().enabled = true, toolTip = "Makes you look like your left controller is broken, hold <color=green>X</color> to move your right hand with your left hand."},
            ...
            new ButtonInfo[] { // Advantage Mods [10]
                ...
                new ButtonInfo { buttonText = "Tag Reach", method =() => Advantages.TagReach(), disableMethod =() => Patches.SphereCastPatch.patchEnabled = false, toolTip = "Makes your hand tag hitbox larger."},
            ...
            new ButtonInfo[] { // Fun Mods [12]
                ...
                new ButtonInfo { buttonText = "Beach Ball Gun", method =() => Fun.ObjectToPointGun("BeachBall"), toolTip = "Moves the beach ball to wherever your hand desires." },
                ...
                new ButtonInfo { buttonText = "Spaz Beach Ball", method =() => Fun.SpazObject("BeachBall"), toolTip = "Gives the beach ball a seizure." },
                ...
                new ButtonInfo { buttonText = "Orbit Beach Ball", method =() => Fun.OrbitObject("BeachBall", 240f), toolTip = "Orbits the beach ball around you." },
                ...
                new ButtonInfo { buttonText = "Ride Beach Ball", method =() => Fun.RideObject("BeachBall"), toolTip = "Repeatedly teleports you on top of the beach ball." },
                ...
                new ButtonInfo { buttonText = "Destroy Beach Ball", method =() => Fun.DestroyObject("BeachBall"), isTogglable = false, toolTip = "Sends the beach ball to hell." },
                ...
                new ButtonInfo { buttonText = "Remove Name", method =() => ChangeName("________"), isTogglable = false, toolTip = "Sets your name to nothing." },
