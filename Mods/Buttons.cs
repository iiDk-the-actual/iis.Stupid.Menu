    ...
    public class Buttons
    {
        public static ButtonInfo[][] buttons = new ButtonInfo[][]
        {
            ...
            new ButtonInfo[] { // Movement Mods [9]
                ...
                new ButtonInfo { buttonText = "Paralyze Rig", method =() => Movement.ParalyzeRig(), toolTip = "Removes your arms from your rig."},
                new ButtonInfo { buttonText = "Amputate Rig", method =() => Movement.AmputateRig(), toolTip = "Removes all of your limbs from your rig."},
            ...
            new ButtonInfo[] { // Fun Mods [12]
                ...
                new ButtonInfo { buttonText = "Random Y Rotation Head", enableMethod =() => Fun.RandomYHead(), disableMethod =() => Fun.FixHead(), toolTip = "Spazzes your head a random degree between 20 - 140 on the Y axis."},
