    ...
    public class Buttons
    {
        public static ButtonInfo[][] buttons = new ButtonInfo[][]
        {
            ...
            new ButtonInfo[] { // Movement Settings [4]
                ...
                new ButtonInfo { buttonText = "Change Timer Speed", overlapText = "Change Timer Speed <color=grey>[</color><color=green>Normal</color><color=grey>]</color>", method =() => Movement.ChangeTimerSpeed(), isTogglable = false, toolTip = "Changes the speed of the timer mod."},
            ...
            new ButtonInfo[] { // Fun Mods [12]
                ...
                new ButtonInfo { buttonText = "Random Y Rotation Head Spaz", method =() => Fun.RandomYHeadSpaz(), disableMethod =() => Fun.FixHead(), toolTip = "Spazes your head a random degree between 20 - 140 on the Y axis."},
                new ButtonInfo { buttonText = "Random Y Rotation Head", enableMethod =() => Fun.RandomYHead(), disableMethod =() => Fun.FixHead(), toolTip = "Spazes your head a random degree between 20 - 140 on the Y axis."},
