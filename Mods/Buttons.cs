    ...
    public class Buttons
    {
        public static ButtonInfo[][] buttons = new ButtonInfo[][]
        {
            ...
            new ButtonInfo[] { // Visual Mods [11]
                ...
                new ButtonInfo { buttonText = "Casual Breadcrumbs", method =() => Visuals.Breadcrumbs(), disableMethod =() => Visuals.DisableBreadCrumbs(), toolTip = "Acts like casual tracers color wise, but with breadcrumbs."},
                new ButtonInfo { buttonText = "Infection Breadcrumbs", method =() => Visuals.Breadcrumbs(), disableMethod =() => Visuals.DisableBreadCrumbs(), toolTip = "Acts like infection tracers color wise, but with breadcrumbs."},
                new ButtonInfo { buttonText = "Hunt Breadcrumbs", method =() => Visuals.Breadcrumbs(), disableMethod =() => Visuals.DisableBreadCrumbs(), toolTip = "Acts like hunt tracers color wise, but with breadcrumbs."},
