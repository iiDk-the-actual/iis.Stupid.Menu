    ...
    public static class Fun
    {
        ...
        public static void WhiteGun()
        {
            if (GetGunInput(false))
            {
                ...
                if (gunLocked && lockTarget != null)
                {
					lockTarget.mainSkin.material.color = Color.white;
                }
        ...
        public static void GrayGun()
        {
            if (GetGunInput(false))
            {
                ...
                if (gunLocked && lockTarget != null)
                {
		            Vector3 grayColorValue = new Vector3(Mathf.Sin(elapsedTime * 2f), Mathf.Sin(elapsedTime * 1.5f), Mathf.Sin(elapsedTime * 2.5f)) * 0.5f + Vector3.one * 0.5f;
		            Color grayColor = new Color(grayColorValue.x, grayColorValue.y, grayColorValue.z);
					
					lockTarget.mainSkin.material.color = grayColor;
                }
        ...
        public static void GrayAll()
        {
		    Vector3 grayColorValue = new Vector3(Mathf.Sin(elapsedTime * 2f), Mathf.Sin(elapsedTime * 1.5f), Mathf.Sin(elapsedTime * 2.5f)) * 0.5f + Vector3.one * 0.5f;
		    Color grayColor = new Color(grayColorValue.x, grayColorValue.y, grayColorValue.z);
			
            foreach (VRRig vrrig in GorillaParent.instance.vrrigs.Where(rig => !rig.IsLocal()))
				vrrig.mainSkin.material.color = grayColor;
        }
        ...
        public static void BlackGun()
        {
            if (GetGunInput(false))
            {
                ...
                if (gunLocked && lockTarget != null)
                {
					lockTarget.mainSkin.material.color = Color.black;
                }
