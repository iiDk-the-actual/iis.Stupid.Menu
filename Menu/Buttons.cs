    ...
    public static class Buttons
    {
        public static ButtonInfo[][] buttons =
        {
            ...
            new[] { // Safety Mods [8]
                ...
                new ButtonInfo { buttonText = "Anti Ban Crash", enableMethod =() => BanPatches.AntiBanCrash.enabled = true, disableMethod =() => BanPatches.AntiBanCrash.enabled = false, toolTip = "Prevents your game from crashing when you are banned."},
