    ...
    public class Buttons
    {
        public static ButtonInfo[][] buttons = new ButtonInfo[][]
        {
            ...
            new ButtonInfo[] { // Overpowered Mods [17]
                ...
                new ButtonInfo { buttonText = "Crash on Grab", method =() => Overpowered.TowardsPositionOnGrab(new Vector3(0, 250, 0)), toolTip = "Crashes the player when they grab you." }, //makes them fall slowly into the quitbox
