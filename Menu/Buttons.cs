    ...
    public class Buttons
    {
        public static ButtonInfo[][] buttons = new ButtonInfo[][]
        {
            ...
            new ButtonInfo[] { // Menu Settings [2]
                ...
                ew ButtonInfo { buttonText = "Disable Menu Title", method =() => { if (pageButtonType == 1) buttonOffset = 1; else buttonOffset = -1; hidetitle = true; if (!reloadmenuonce) { ReloadMenu(); reloadmenuonce = true; } }, disableMethod =() => { if (pageButtonType == 1) buttonOffset = 2; else buttonOffset = 0; hidetitle = false; if (reloadmenuonce) { ReloadMenu(); reloadmenuonce = false; } }, toolTip = "Hides the menu title, allowing for more buttons per page."},
