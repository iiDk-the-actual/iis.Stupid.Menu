    ...
    public class Buttons
    {
        public static ButtonInfo[][] buttons = new ButtonInfo[][]
        {
            ...
            new ButtonInfo[] { // Visual Mods [11]
                ...
                new ButtonInfo { buttonText = "Play Time Overlay", method =() => { NotifiLib.information["PlayTime"] = Visuals.OverallPlayTime; Visuals.UpdatePlayTime(); }, disableMethod =() => NotifiLib.information.Remove("PlayTime"), toolTip = "Displays your play time from when the mod was enabled on your screen."},
