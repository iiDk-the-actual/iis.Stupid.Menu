    ...
    public static class Buttons
    {
        public static ButtonInfo[][] buttons =
        {
            ...
            new[] { // Movement Mods [9]
                ...
                new ButtonInfo { buttonText = "Legitimate Pull Mod", method = Movement.LegitimatePullMod, toolTip = "Pulls you more whenever you walk to simulate speed without modifying your velocity while passing most pull checks."},
