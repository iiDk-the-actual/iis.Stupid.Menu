    ...
    public static class Buttons
    {
        public static ButtonInfo[][] buttons =
        {
            ...
            new[] { // Fun Mods [12]
                ...
                new ButtonInfo { buttonText = "Bug Spam Gun", method =() => Overpowered.SpamObjectGun(Overpowered.objectByName["GhostReactorEnemyPest"]), toolTip = "Spawns the annoying bug enemies at wherever your hand desires."},
                new ButtonInfo { buttonText = "Large Bug Spam Gun", method =() => Overpowered.SpamObjectGun(Overpowered.objectByName["GhostReactorEnemyPestBig"]), toolTip = "Spawns the large annoying bug enemies at wherever your hand desires."},
