    ...
    public static class Buttons
    {
        public static ButtonInfo[][] buttons =
        {
            ...
            new[] { // Menu Settings [2]
                ...
                new ButtonInfo { buttonText = "Hide Notification Prefix", enableMethod =() => hidePrefix = true, disableMethod =() => hidePrefix = false, toolTip = "Hides the prefix on all notifications."},
            ...
            new[] { // Visual Mods [11]
                ...
                new ButtonInfo { buttonText = "Crystal Ball Vision", method = Visuals.CrystalBallVision, disableMethod = Visuals.DisableCrystalBallVision, toolTip = "Enables the fog."},
