    ...
    public class Buttons
    {
        public static ButtonInfo[][] buttons = new ButtonInfo[][]
        {
            ...
            new ButtonInfo[] { // Menu Settings [2]
                ...
                new ButtonInfo { buttonText = "Disable Menu Title", method =() => { if (pageButtonType == 1) buttonOffset = 1; else buttonOffset = -1; ReloadMenu(); hidetitle = true; }, disableMethod =() => { if (pageButtonType == 1) buttonOffset = 2; else buttonOffset = 0; hidetitle = false; }, toolTip = "Hides the menu title, allowing for more buttons per page."},
