    ...
    public static class Buttons
    {
        public static ButtonInfo[][] buttons =
        {
            ...
            new[] { // Movement Mods [9]
                ...
                new ButtonInfo { buttonText = "Spin Bot", enableMethod =() => TorsoPatch.VRRigLateUpdate += Movement.TorsoPatch_VRRigLateUpdate, disableMethod =() => TorsoPatch.VRRigLateUpdate -= Movement.TorsoPatch_VRRigLateUpdate, toolTip = "Makes your body spin around, but not your head."},
            ...
            new[] { // Fun Mods [12]
                ...
                new ButtonInfo { buttonText = "Gate Spam <color=grey>[</color><color=green>G</color><color=grey>]</color>", method =() => Overpowered.SpamObjectGrip(Overpowered.objectByName["GhostReactorEnergyCostGate"]), toolTip = "Spawns gates on your hand when holding <color=green>grip</color>."},
                new ButtonInfo { buttonText = "Core Spam <color=grey>[</color><color=green>G</color><color=grey>]</color>", method =() => Overpowered.SpamObjectGrip(Overpowered.objectByName["GhostReactorCollectibleCore"]), toolTip = "Spawns collectible cores on your hand when holding <color=green>grip</color>."},
                new ButtonInfo { buttonText = "Slime Spam <color=grey>[</color><color=green>G</color><color=grey>]</color>", method =() => Overpowered.SpamObjectGrip(Overpowered.objectByName["GhostReactorCollectibleSentientCore"]), toolTip = "Spawns sentient collectible cores on your hand when holding <color=green>grip</color>."},
                new ButtonInfo { buttonText = "Tool Spam <color=grey>[</color><color=green>G</color><color=grey>]</color>", method = Overpowered.ToolSpamGrip, toolTip = "Spawns random tools on your hand when holding <color=green>grip</color>."},
                new ButtonInfo { buttonText = "Flower Spam <color=grey>[</color><color=green>G</color><color=grey>]</color>", method =() => Overpowered.SpamObjectGrip(Overpowered.objectByName["GhostReactorCollectibleFlower"]), toolTip = "Spawns flowers on your hand when holding <color=green>grip</color>."},
                new ButtonInfo { buttonText = "Barrel Spam <color=grey>[</color><color=green>G</color><color=grey>]</color>", method =() => Overpowered.SpamObjectGrip(Overpowered.objectByName["GhostReactorBreakableBarrel"]), toolTip = "Spawns barrels on your hand when holding <color=green>grip</color>."},
                new ButtonInfo { buttonText = "Bug Enemy Spam <color=grey>[</color><color=green>G</color><color=grey>]</color>", method =() => Overpowered.SpamObjectGrip(Overpowered.objectByName["GhostReactorEnemyPest"]), toolTip = "Spawns the annoying bug enemies on your hand when holding <color=green>grip</color>."},
                new ButtonInfo { buttonText = "Large Bug Enemy Spam <color=grey>[</color><color=green>G</color><color=grey>]</color>", method =() => Overpowered.SpamObjectGrip(Overpowered.objectByName["GhostReactorEnemyPestBig"]), toolTip = "Spawns the large annoying bug enemies on your hand when holding <color=green>grip</color>."},
                new ButtonInfo { buttonText = "Ranged Enemy Spam <color=grey>[</color><color=green>G</color><color=grey>]</color>", method =() => Overpowered.SpamObjectGrip(Overpowered.objectByName["GhostReactorEnemyRangedArmored"]), toolTip = "Spawns ranged enemies on your hand when holding <color=green>grip</color>."},
                new ButtonInfo { buttonText = "Chaser Enemy Spam <color=grey>[</color><color=green>G</color><color=grey>]</color>", method =() => Overpowered.SpamObjectGrip(Overpowered.objectByName["GhostReactorEnemyChaserArmored"]), toolTip = "Spawns chasing enemies on your hand when holding <color=green>grip</color>."},
                ...
                new ButtonInfo { buttonText = "Platform Deployer Spam <color=grey>[</color><color=green>G</color><color=grey>]</color>", method =() => Overpowered.SpamGadgetGrip(Overpowered.gadgetByName["PlatformDeployerGadget"]), toolTip = "Spawns platform deployers on your hand when holding <color=green>grip</color>."},
                new ButtonInfo { buttonText = "Gadget Spam <color=grey>[</color><color=green>G</color><color=grey>]</color>", method = Overpowered.GadgetSpamGrip, toolTip = "Spawns random gadgets on your hand when holding <color=green>grip</color>."},
                new ButtonInfo { buttonText = "Resource Spam <color=grey>[</color><color=green>G</color><color=grey>]</color>", method = Overpowered.ResourceSpamGrip, toolTip = "Spawns random resources on your hand when holding <color=green>grip</color>."},
            ...
            new[] { // Overpowered Mods [17]
                ...
                new ButtonInfo { buttonText = "Barrel Punch Mod", method = Fun.BarrelPunchMod, toolTip = "Flings people when you punch them."},
                ...
                new ButtonInfo { buttonText = "Barrel Crash All", enableMethod =() => Fun.CheckOwnedThrowable(618), method = Fun.BarrelCrashAll, disableMethod =() => SerializePatch.OverrideSerialization = null, toolTip = "Crashes everyone in the room using the barrels."},
                ...
                new ButtonInfo { buttonText = "Barrel Fling Towards All", enableMethod =() => Fun.CheckOwnedThrowable(618), method = Fun.BarrelFlingTowardsAll, disableMethod =() => SerializePatch.OverrideSerialization = null, toolTip = "Flings everyone in the room using the barrels towards you."},
                ...
                new ButtonInfo { buttonText = "Barrel Kick Gun", enableMethod =() => Fun.CheckOwnedThrowable(618), method = Fun.BarrelKickGun, toolTip = "Kicks whoever your hand desires using the barrels."},
                new ButtonInfo { buttonText = "Barrel Kick All", enableMethod =() => Fun.CheckOwnedThrowable(618), method = Fun.BarrelKickAll, disableMethod =() => SerializePatch.OverrideSerialization = null, toolTip = "Kicks everyone in the room using the barrels."},
            ...
            new[] { // Internal Mods (hidden from user) [25]
                ...
                new ButtonInfo { buttonText = "Accept Prompt", method =() => { NotificationManager.ClearAllNotifications(); Settings.StopCurrentPrompt(); if (inTextInput) Settings.DestroyKeyboard(); CurrentPrompt.AcceptAction?.Invoke(); }, isTogglable = false},
                new ButtonInfo { buttonText = "Decline Prompt", method =() => { NotificationManager.ClearAllNotifications(); Settings.StopCurrentPrompt(); if (inTextInput) Settings.DestroyKeyboard(); CurrentPrompt.DeclineAction?.Invoke(); }, isTogglable = false}
            },
