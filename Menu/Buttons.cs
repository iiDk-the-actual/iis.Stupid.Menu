    ...
    public static class Buttons
    {
        public static ButtonInfo[][] buttons =
        {
            ...
            new[] { // Projectiles Settings [5]
                ...
                new ButtonInfo { buttonText = "No Delay Snowballs", enableMethod =() => Overpowered.NoDelaySnowballs = true, disableMethod =() => Overpowered.NoDelaySnowballs = false, toolTip = "Uses every form of snowball to lower the delay to 0.05." }
            },
