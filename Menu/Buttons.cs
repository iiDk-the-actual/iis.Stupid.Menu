    ...
    public static class Buttons
    {
        public static ButtonInfo[][] buttons =
        {
            ...
            new[] { // Menu Settings [2]
                ...
                new ButtonInfo { buttonText = "AI Assistant", enableMethod = Settings.DictationOn, disableMethod = Settings.DictationOff, toolTip = "A voice assistant with artificial intelligence capabilities."},
