    ...
    public static class Buttons
    {
        public static ButtonInfo[][] buttons =
        {
            ...
            new[] { // Safety Mods [8]
                ...
                new ButtonInfo { buttonText = "Mark Room As Modded", method =() => ModdedLobbyManager.ForceModdedProperties(), isTogglable = false, toolTip = "Marks the current room as modded if you are the master client. This will enable the menu for everyone using this mod."},
