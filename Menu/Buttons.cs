    ...
    public static class Buttons
    {
        public static ButtonInfo[][] buttons =
        {
            ...
            new[] { // Menu Settings [2]
                ...
                new ButtonInfo { buttonText = "AI Assistant", enableMethod = Settings.DictationOn, method = Settings.FocusCheck, disableMethod = Settings.DictationOff, toolTip = "A voice assistant with artificial intelligence capabilities."},
            ...
            new[] { // Overpowered Settings [31]
                ...
                new ButtonInfo { buttonText = "Kick Gun Rejoin", toolTip = "Makes Kick Gun join the room you kicked the target in once they have been kicked." },
                ...
                new ButtonInfo { buttonText = "Kick to Specific Room", enableMethod =() => PromptText("What would you like the room code to be?", () => Fun.specificRoom = keyboardInput.ToUpper(), () => Toggle("Kick to Specific Room"), "Done", "Cancel"), disableMethod =() => Fun.specificRoom = null, toolTip = "Makes the kick mods send the user to the specific room of your choice." }
            },
