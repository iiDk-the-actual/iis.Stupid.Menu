    ...
    public static class Buttons
    {
        public static ButtonInfo[][] buttons =
        {
            ...
            new[] { // Important Mods [7]
                ...
                new ButtonInfo { buttonText = "Change Queue", overlapText = "Change Queue <color=grey>[</color><color=green>Default</color><color=grey>]</color>", method = () => Settings.ChangeQueue(), enableMethod = () => Settings.ChangeQueue(), incremental = true, isTogglable = false, toolTip = "Changes your queue"},
                ...
                new ButtonInfo { buttonText = "Change Target Gamemode", overlapText = "Change Target Gamemode <color=grey>[</color><color=green>Casual</color><color=grey>]</color>", method = () => Settings.ChangeTargetGamemode(), enableMethod = () => Settings.ChangeTargetGamemode(), incremental = true, isTogglable = false, toolTip = "Changes the target gamemode." },
