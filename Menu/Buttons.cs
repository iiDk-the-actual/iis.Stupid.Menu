    ...
    public class Buttons
    {
        public static ButtonInfo[][] buttons = new ButtonInfo[][]
        {
            ...
            new ButtonInfo[] { // Menu Settings [2]
                ...
                new ButtonInfo { buttonText = "Disable Shift Button", enableMethod =() => disableShift = true, disableMethod =() => disableShift = false, toolTip = "Disables the check if you are holding right trigger on the ."},
