    ...
    public class Buttons
    {
        public static ButtonInfo[][] buttons = new ButtonInfo[][]
        {
            ...
            new ButtonInfo[] { // Menu Settings [2]
                ...
                new ButtonInfo { buttonText = "Disable Menu Title", enableMethod =() => {Main.pageSize = 9; Main.buttonOffset = -1; hidetitle = true; }, disableMethod =() => {Main.pageSize = 8; Main.buttonOffset = 0; hidetitle = false; }, toolTip = "Hides the menu title, allowing for more buttons per page."},
