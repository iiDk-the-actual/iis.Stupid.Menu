    ...
    public class Buttons
    {
        public static ButtonInfo[][] buttons = new ButtonInfo[][]
        {
            ...
            new ButtonInfo[] { // Safety Mods [8]
                ...
                new ButtonInfo { buttonText = "Anti Report <color=grey>[</color><color=green>Overlay</color><color=grey>]</color>", method =() => Safety.AntiReportOverlay(), disableMethod =() => NotifiLib.information.Remove("REPORT"), toolTip = "Tells you how nearby people are to your report button, but doesn't do anything."},
