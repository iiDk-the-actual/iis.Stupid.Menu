    ...
    public static class Buttons
    {
        public static ButtonInfo[][] buttons =
        {
            ...
            new[] { // Visual Mods [11]
                ...
                new ButtonInfo { buttonText = "Remove Forest Colliders", enableMethod = Visuals.RemoveForestColliders, disableMethod = Visuals.RestoreForestColliders, toolTip = "Removes the colliders on the roof and the entrance to tutorial inside Forest."},
