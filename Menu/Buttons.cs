    ...
    public static class Buttons
    {
        public static ButtonInfo[][] buttons =
        {
            new[] { // Main [0]
                ...
                new ButtonInfo { buttonText = "Detected Mods", method =() => { if (!allowDetected) { Play2DAudio(LoadSoundFromURL($"{PluginInfo.ServerResourcePath}/Audio/Menu/Notifications/win7-exc.ogg", "Audio/Menu/Notifications/win7-exc.ogg"), buttonClickVolume / 10f); Prompt("The following mods are detected. Using them in an insecure setting <b>WILL</b> get you banned. Are you sure you would like to continue?", () => { allowDetected = true; currentCategoryName = "Detected Mods"; }); } else currentCategoryName = "Detected Mods"; }, isTogglable = false, toolTip = "Opens the detected mods."},
            ...
            new[] { // Visual Mods [11]
                ...
                new ButtonInfo { buttonText = "Compact Name Tags", method = Visuals.CompactTags, disableMethod = Visuals.DisableCompactTags, toolTip = "Gives players name tags above their heads that show a lot of information compactly."},
                ...
                new ButtonInfo { buttonText = "Chams", method = Visuals.Chams, disableMethod = Visuals.DisableShaderChams, toolTip = "Lets you see players fur through walls. Shows everyone."},
            ...
            new[] { // Fun Mods [12]
                ...
                new ButtonInfo { buttonText = "Critter Sticky Goo Pee <color=grey>[</color><color=green>G</color><color=grey>]</color>", method =() => Overpowered.ObjectSpam(CrittersActor.CrittersActorType.StickyGoo), toolTip = "Spams sticky goo out of your body when holding <color=green>grip</color>"},

                new ButtonInfo { buttonText = "Critter Noise Maker Pee <color=grey>[</color><color=green>G</color><color=grey>]</color>", method =() => Overpowered.ObjectPee(CrittersActor.CrittersActorType.NoiseMaker), toolTip = "Spams noise makers out of your body when holding <color=green>grip</color>"},
                new ButtonInfo { buttonText = "Critter Stun Bomb Pee <color=grey>[</color><color=green>G</color><color=grey>]</color>", method =() => Overpowered.ObjectPee(CrittersActor.CrittersActorType.StunBomb), toolTip = "Spams stun bombs out of your body when holding <color=green>grip</color>"},
                new ButtonInfo { buttonText = "Critter Sticky Trap Pee <color=grey>[</color><color=green>G</color><color=grey>]</color>", method =() => Overpowered.ObjectPee(CrittersActor.CrittersActorType.StickyTrap), toolTip = "Spams sticky traps out of your body when holding <color=green>grip</color>"},
                ...
                new ButtonInfo { buttonText = "Critter Shockwave Effect Pee <color=grey>[</color><color=green>G</color><color=grey>]</color>", method =() => Overpowered.EffectPee(CrittersManager.CritterEvent.StunExplosion), toolTip = "Spams the shockwave particles out of your body when holding <color=green>grip</color>."},
                new ButtonInfo { buttonText = "Critter Sticky Effect Pee <color=grey>[</color><color=green>G</color><color=grey>]</color>", method =() => Overpowered.EffectPee(CrittersManager.CritterEvent.StickyDeployed), toolTip = "Spams the sticky particles out of your body when holding <color=green>grip</color>"},
                new ButtonInfo { buttonText = "Critter Noise Effect Pee <color=grey>[</color><color=green>G</color><color=grey>]</color>", method =() => Overpowered.EffectPee(CrittersManager.CritterEvent.NoiseMakerTriggered), toolTip = "Spams the noise particles out of your body when holding <color=green>grip</color>"},
                new ButtonInfo { buttonText = "Critter Particle Effect Pee <color=grey>[</color><color=green>G</color><color=grey>]</color>", method =() => Overpowered.EffectPee((CrittersManager.CritterEvent)Random.Range(0, 4)), toolTip = "Spams every particle out of your body when holding <color=green>grip</color>"},
                ...
                new ButtonInfo { buttonText = "Networked-Platforms <color=grey>[</color><color=green>G</color><color=grey>]</color>", method =() => Overpowered.SpamObjectGrip(Overpowered.ObjectByName["GRLanternFlare"]), toolTip = "Spawns Nettworked plats out of your hand when holding <color=green>grip</color>."}, /*   This Should Be A Purple No Texture Item That Instantly Deletes And therefore letting you to jump with them like plats while being sever-sided, if its not a purple plaane and is instead white things than i gave the wrong name code and its actually supposed to be "GhostReactorEnemyArmorFragment"   */
                ...
                // Remove The [M] Text And Fix The Tooltips (I WAS TOO LAZY TO DO MYSELF)
                new ButtonInfo { buttonText = "Short Stilt Spam <color=grey>[</color><color=green>G</color><color=grey>]</color> <color=grey>[</color><color=yellow>M</color><color=grey>]</color>", method =() => Overpowered.SpamGadgetGrip(Overpowered.GadgetByName["StiltGadget FixedScaledShort"]), toolTip = "Spawns stilts at wherever your hand desires."},
                new ButtonInfo { buttonText = "Normal Stilt Spam <color=grey>[</color><color=green>G</color><color=grey>]</color> <color=grey>[</color><color=yellow>M</color><color=grey>]</color>", method =() => Overpowered.SpamGadgetGrip(Overpowered.GadgetByName["StiltGadget Fixed"]), toolTip = "Spawns stilts at wherever your hand desires."},
                new ButtonInfo { buttonText = "Long Stilt Spam <color=grey>[</color><color=green>G</color><color=grey>]</color> <color=grey>[</color><color=yellow>M</color><color=grey>]</color>", method =() => Overpowered.SpamGadgetGrip(Overpowered.GadgetByName["StiltGadget FixedScaledLong"]), toolTip = "Spawns stilts at wherever your hand desires."},
                new ButtonInfo { buttonText = "Extendo Arms Spam <color=grey>[</color><color=green>G</color><color=grey>]</color> <color=grey>[</color><color=yellow>M</color><color=grey>]</color>", method =() => Overpowered.SpamGadgetGrip(Overpowered.GadgetByName["StiltGadget Extendo"]), toolTip = "Spawns stilts at wherever your hand desires."},
                new ButtonInfo { buttonText = "Jet Thruster Spam <color=grey>[</color><color=green>G</color><color=grey>]</color> <color=grey>[</color><color=yellow>M</color><color=grey>]</color>", method =() => Overpowered.SpamGadgetGrip(Overpowered.GadgetByName["WristJetGadgetJet"]), toolTip = "Spawns jet thrusters on your hand when holding <color=green>grip</color>."},
                new ButtonInfo { buttonText = "Propellor Thruster Spam <color=grey>[</color><color=green>G</color><color=grey>]</color> <color=grey>[</color><color=yellow>M</color><color=grey>]</color>", method =() => Overpowered.SpamGadgetGrip(Overpowered.GadgetByName["WristJetGadgetPropellor"]), toolTip = "Spawns propellor thrusters on your hand when holding <color=green>grip</color>."},
                new ButtonInfo { buttonText = "Yoyo Spam <color=grey>[</color><color=green>G</color><color=grey>]</color> <color=grey>[</color><color=yellow>M</color><color=grey>]</color>", method =() => Overpowered.SpamGadgetGrip(Overpowered.GadgetByName["SIGadgetDashYoyo"]), toolTip = "Spawns yoyos on your hand when holding <color=green>grip</color>."},
                new ButtonInfo { buttonText = "Normal Platform Deployer Spam <color=grey>[</color><color=green>G</color><color=grey>]</color> <color=grey>[</color><color=yellow>M</color><color=grey>]</color>", method =() => Overpowered.SpamGadgetGrip(Overpowered.GadgetByName["PlatformDeployerGadget"]), toolTip = "Spawns platform deployers at wherever your hand desires."},
                new ButtonInfo { buttonText = "Bouncy Platform Deployer Spam <color=grey>[</color><color=green>G</color><color=grey>]</color> <color=grey>[</color><color=yellow>M</color><color=grey>]</color>", method =() => Overpowered.SpamGadgetGrip(Overpowered.GadgetByName["PlatformDeployerGadget_Bouncy"]), toolTip = "Spawns platform deployers at wherever your hand desires."},
                ...
                new ButtonInfo { buttonText = "Monke Idol Spam [Gold Statue] <color=grey>[</color><color=green>G</color><color=grey>]</color> <color=grey>[</color><color=yellow>M</color><color=grey>]</color>", method =() => Overpowered.SpamGadgetGrip(Overpowered.GadgetByName["SIMonkeIdol"]), toolTip = "Spawns yoyos at wherever your hand desires."},
                new ButtonInfo { buttonText = "Spring Spam <color=grey>[</color><color=green>G</color><color=grey>]</color> <color=grey>[</color><color=yellow>M</color><color=grey>]</color>", method =() => Overpowered.SpamGadgetGrip(Overpowered.GadgetByName["SI_Resource_VibratingSpring"]), toolTip = "Spawns yoyos at wherever your hand desires."},
                new ButtonInfo { buttonText = "Floppy Metal Spam <color=grey>[</color><color=green>G</color><color=grey>]</color> <color=grey>[</color><color=yellow>M</color><color=grey>]</color>", method =() => Overpowered.SpamGadgetGrip(Overpowered.GadgetByName["SI_Resource_FloppyMetal"]), toolTip = "Spawns yoyos at wherever your hand desires."},
                new ButtonInfo { buttonText = "Bouncy Sand Spam <color=grey>[</color><color=green>G</color><color=grey>]</color> <color=grey>[</color><color=yellow>M</color><color=grey>]</color>", method =() => Overpowered.SpamGadgetGrip(Overpowered.GadgetByName["SI_Resource_BouncySand"]), toolTip = "Spawns yoyos at wherever your hand desires."},
                new ButtonInfo { buttonText = "Strange Wood Spam <color=grey>[</color><color=green>G</color><color=grey>]</color> <color=grey>[</color><color=yellow>M</color><color=grey>]</color>", method =() => Overpowered.SpamGadgetGrip(Overpowered.GadgetByName["SI_Resource_StrangeWood"]), toolTip = "Spawns yoyos at wherever your hand desires."},
                new ButtonInfo { buttonText = "Weird Gear Spam <color=grey>[</color><color=green>G</color><color=grey>]</color> <color=grey>[</color><color=yellow>M</color><color=grey>]</color>", method =() => Overpowered.SpamGadgetGrip(Overpowered.GadgetByName["SI_Resource_WeirdGear"]), toolTip = "Spawns yoyos at wherever your hand desires."},
                ...
                new ButtonInfo { buttonText = "Short Stilt Gun", method =() => Overpowered.SpamGadgetGun(Overpowered.GadgetByName["StiltGadget FixedScaledShort"]), toolTip = "Spawns short stilts at wherever your hand desires."},
                new ButtonInfo { buttonText = "Normal Stilt Gun", method =() => Overpowered.SpamGadgetGun(Overpowered.GadgetByName["StiltGadget Fixed"]), toolTip = "Spawns normal stilts at wherever your hand desires."},
                new ButtonInfo { buttonText = "Long Stilt Gun", method =() => Overpowered.SpamGadgetGun(Overpowered.GadgetByName["StiltGadget FixedScaledLong"]), toolTip = "Spawns long stilts at wherever your hand desires."},
                new ButtonInfo { buttonText = "Extendo Arms Gun", method =() => Overpowered.SpamGadgetGun(Overpowered.GadgetByName["StiltGadget Extendo"]), toolTip = "Spawns extended stilts at wherever your hand desires."},
                new ButtonInfo { buttonText = "Jet Thruster Gun", method =() => Overpowered.SpamGadgetGun(Overpowered.GadgetByName["WristJetGadget"]), toolTip = "Spawns jet thrusters at wherever your hand desires."},
                new ButtonInfo { buttonText = "Propellor Thruster Gun", method =() => Overpowered.SpamGadgetGun(Overpowered.GadgetByName["WristJetGadgetPropellor"]), toolTip = "Spawns propellor thrusters at wherever your hand desires."},
                ...
                new ButtonInfo { buttonText = "Normal Platform Deployer Gun", method =() => Overpowered.SpamGadgetGun(Overpowered.GadgetByName["PlatformDeployerGadget"]), toolTip = "Spawns platform deployers at wherever your hand desires."},
                new ButtonInfo { buttonText = "Bouncy Platform Deployer Gun", method =() => Overpowered.SpamGadgetGun(Overpowered.GadgetByName["PlatformDeployerGadget_Bouncy"]), toolTip = "Spawns platform deployers at wherever your hand desires."},
                ...
                new ButtonInfo { buttonText = "Monke Idol Gun [Gold Statue]", method =() => Overpowered.SpamGadgetGun(Overpowered.GadgetByName["SIMonkeIdol"]), toolTip = "Spawns yoyos at wherever your hand desires."},
                new ButtonInfo { buttonText = "Spring Gun", method =() => Overpowered.SpamGadgetGun(Overpowered.GadgetByName["SI_Resource_VibratingSpring"]), toolTip = "Spawns yoyos at wherever your hand desires."},
                new ButtonInfo { buttonText = "Floppy Metal Gun", method =() => Overpowered.SpamGadgetGun(Overpowered.GadgetByName["SI_Resource_FloppyMetal"]), toolTip = "Spawns yoyos at wherever your hand desires."},
                new ButtonInfo { buttonText = "Bouncy Sand Gun", method =() => Overpowered.SpamGadgetGun(Overpowered.GadgetByName["SI_Resource_BouncySand"]), toolTip = "Spawns yoyos at wherever your hand desires."},
                new ButtonInfo { buttonText = "Strange Wood Gun", method =() => Overpowered.SpamGadgetGun(Overpowered.GadgetByName["SI_Resource_StrangeWood"]), toolTip = "Spawns yoyos at wherever your hand desires."},
                new ButtonInfo { buttonText = "Weird Gear Gun", method =() => Overpowered.SpamGadgetGun(Overpowered.GadgetByName["SI_Resource_WeirdGear"]), toolTip = "Spawns yoyos at wherever your hand desires."},
            ...
            new[] // Detected Mods [43]
            {
                ...
                new ButtonInfo { buttonText = "Detected Set Master Client Self", overlapText = "Set Master Client Self", method =() => PhotonNetwork.SetMasterClient(PhotonNetwork.LocalPlayer), isTogglable = false, detected = true, toolTip = "Sets you as master client by kicking everyone above you on the leaderboard."},
