    ...
    public class Buttons
    {
        public static ButtonInfo[][] buttons = new ButtonInfo[][]
        {
            ...
            new ButtonInfo[] { // Important Mods [7]
                ...
                new ButtonInfo { buttonText = "Steam Refund Timer", method =() => { if (playTime > 6000) { NotifiLib.information["REFUND"] = "Refund soon"; } }, disableMethod =() => NotifiLib.information.Remove("REFUND"), toolTip = "Alerts you when you are nearby the steam refund time."},
