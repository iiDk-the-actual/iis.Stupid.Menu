    ...
    public static class Buttons
    {
        public static ButtonInfo[][] buttons =
        {
            ...
            new[] { // Important Mods [7]
                ...
                new ButtonInfo { buttonText = "Change Color", method =() => PromptText("What would you like your color to be? (RGB)", () => Important.SetColor(keyboardInput), null, "Done", "Cancel"), isTogglable = false, toolTip = "Sets your color code to whatever you desire." },
                ...
                new ButtonInfo { buttonText = "Change Queue", overlapText = "Change Queue <color=grey>[</color><color=green>Default</color><color=grey>]</color>", method = () => Settings.ChangeQueue(), enableMethod = () => Settings.ChangeQueue(), disableMethod =() => Settings.ChangeQueue(false), incremental = true, isTogglable = false, toolTip = "Changes your queue"},
                /*ButtonInfo { buttonText = "Change Queue to Default", overlapText = "Change Queue <color=grey>[</color><color=green>Default</color><color=grey>]</color>", method =() => GorillaComputer.instance.currentQueue = "DEFAULT", isTogglable = false, toolTip = "Changes your queue to default."},
                ...
                new ButtonInfo { buttonText = "Change Target Gamemode", overlapText = "Change Target Gamemode <color=grey>[</color><color=green>Casual</color><color=grey>]</color>", method = () => Settings.ChangeTargetGamemode(), enableMethod = () => Settings.ChangeTargetGamemode(), disableMethod =() => Settings.ChangeTargetGamemode(false), incremental = true, isTogglable = false, toolTip = "Changes the target gamemode." },
            ...
            new[] { // Fun Mods [12]
                ...
                new ButtonInfo { buttonText = "Tool Spam <color=grey>[</color><color=green>G</color><color=grey>]</color>", method = Overpowered.ToolSpamGrip, toolTip = "Spawns random tools at wherever your hand desires."},
                new ButtonInfo { buttonText = "Flower Spam <color=grey>[</color><color=green>G</color><color=grey>]</color>", method =() => Overpowered.SpamObjectGrip(Overpowered.objectByName["GhostReactorCollectibleFlower"]), toolTip = "Spawns flowers at wherever your hand desires."},
                new ButtonInfo { buttonText = "Barrel Spam <color=grey>[</color><color=green>G</color><color=grey>]</color>", method =() => Overpowered.SpamObjectGrip(Overpowered.objectByName["GhostReactorBreakableBarrel"]), toolTip = "Spawns barrels at wherever your hand desires."},
                new ButtonInfo { buttonText = "Bug Enemy Spam <color=grey>[</color><color=green>G</color><color=grey>]</color>", method =() => Overpowered.SpamObjectGrip(Overpowered.objectByName["GhostReactorEnemyPest"]), toolTip = "Spawns the annoying bug enemies at wherever your hand desires."},
                new ButtonInfo { buttonText = "Large Bug Enemy Spam <color=grey>[</color><color=green>G</color><color=grey>]</color>", method =() => Overpowered.SpamObjectGrip(Overpowered.objectByName["GhostReactorEnemyPestBig"]), toolTip = "Spawns the large annoying bug enemies at wherever your hand desires."},
                new ButtonInfo { buttonText = "Ranged Enemy Spam <color=grey>[</color><color=green>G</color><color=grey>]</color>", method =() => Overpowered.SpamObjectGrip(Overpowered.objectByName["GhostReactorEnemyRangedArmored"]), toolTip = "Spawns ranged enemies at wherever your hand desires."},
                new ButtonInfo { buttonText = "Chaser Enemy Spam <color=grey>[</color><color=green>G</color><color=grey>]</color>", method =() => Overpowered.SpamObjectGrip(Overpowered.objectByName["GhostReactorEnemyChaserArmored"]), toolTip = "Spawns chasing enemies at wherever your hand desires."},
