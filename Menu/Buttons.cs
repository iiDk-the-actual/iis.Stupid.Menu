    ...
    public static class Buttons
    {
        public static ButtonInfo[][] buttons =
        {
            ...
            new[] { // Projectiles Settings [5]
                ...
                new ButtonInfo { buttonText = "Change Growing Projectile", overlapText = "Change Growing Projectile <color=grey>[</color><color=green>Mashed Potatoes</color><color=grey>]</color>", method =() => Projectiles.ChangeGrowingProjectile(), enableMethod =() => Projectiles.ChangeGrowingProjectile(), disableMethod =() => Projectiles.ChangeGrowingProjectile(false), incremental = true, isTogglable = false, toolTip = "Changes the projectile of the snowball mods." },
