    ...
    public static class Buttons
    {
        public static ButtonInfo[][] buttons =
        {
            ...
            new[] { // Important Mods [7]
                ...
                new ButtonInfo { buttonText = "Change Queue to Competitive", method =() => GorillaComputer.instance.currentQueue = "COMPETITIVE", isTogglable = false, toolTip = "Changes your queue to competitive."},
            ...
            new[] { // Movement Mods [9]
                ...
                new ButtonInfo { buttonText = "WASD Fly", enableMethod=() => { Movement.lastPosition = GorillaTagger.Instance.rigidbody.transform.position; }, method = Movement.WASDFly, disableMethod =() => GTPlayer.Instance.RightHand.controllerTransform.parent.rotation = Quaternion.Euler(0, 0, 0), toolTip = "Moves your rig with <color=green>WASD</color>."},
