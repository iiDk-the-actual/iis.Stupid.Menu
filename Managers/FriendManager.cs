...
namespace iiMenu.Managers
{
    public class FriendManager : MonoBehaviour
    {
        ...
        public static void DenyFriendRequest(string uid)
        {
            CoroutineManager.instance.StartCoroutine(ExecuteAction(uid, "unfrienduser",
                () => {
                    ...
                    if (SoundEffects)
                        Play2DAudio(LoadSoundFromURL($"{PluginInfo.ServerResourcePath}/Audio/Friends/doorslam.mp3", "doorslam.mp3"), buttonClickVolume / 10f);
                },
        ...
        public static void SendFriendMessage(string uid, string message)
        {
            ...
            if (SoundEffects)
                Play2DAudio(LoadSoundFromURL($"{PluginInfo.ServerResourcePath}/Audio/Friends/send.mp3", "send.mp3"), buttonClickVolume / 10f);
        ...
        public static void FriendsListUpdated()
        {
            ...
            {
                if (SoundEffects)
                    Play2DAudio(LoadSoundFromURL($"{PluginInfo.ServerResourcePath}/Audio/Friends/online.mp3", "online.mp3"), buttonClickVolume / 10f);
            ...
            {
                if (SoundEffects)
                    Play2DAudio(LoadSoundFromURL($"{PluginInfo.ServerResourcePath}/Audio/Friends/dooropen.mp3", "dooropen.mp3"), buttonClickVolume / 10f);
                        ...
                        case "message":
                            {
                                ...
                                if (SoundEffects)
                                    Play2DAudio(LoadSoundFromURL($"{PluginInfo.ServerResourcePath}/Audio/Friends/receive.mp3", "receive.mp3"), buttonClickVolume / 10f);
